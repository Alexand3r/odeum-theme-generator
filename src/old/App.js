...
class App extends Component {
	...
	changeTheme = () => {
		return this.state.theme === greenTheme ? this.setState({ theme: redTheme }) : this.state.theme === redTheme ? this.setState({ theme: theme }) : this.state.theme === theme ? this.setState({ theme: greenTheme }) : null
				...
				*/}
				...
				<MenuPanel>
					<Menu route={'/'} exact helpID={10}>
						...
						<ThemeGenerator submitTheme={this.setTheme}/>
					</Menu>
